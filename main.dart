...
void main() {
  Mahasiswa mahasiswa = Mahasiswa("230103103", "Hawi", 3);

  MataKuliah matkul1 = MataKuliah("MK001", "Pemrograman", 3);
  MataKuliah matkul2 = MataKuliah("MK002", "Matematika Diskrit", 3);
